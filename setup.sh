...
echo ""
echo "  LOCAL AGENT (run on your Mac):"
echo "    cd local_agent"
echo "    pip install -r requirements.txt"
echo "    CORTEX_BACKEND_WS=wss://<cloud-shell-preview-url>/ws python agent.py"
echo ""
echo "    Watches: folders, browser tabs, music, notes, active apps"
echo ""
echo "  Chrome Extension (optional — local agent covers tabs too):"
